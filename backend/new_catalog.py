...
if __name__ == "__main__":
    ...
    if reset_catalogs:
        ...
        #sn.add_normalization(handle="mashonkina25", author="Mashonkina et al.", year=2025, element_dict={"Fe": 7.45, "Pd": 1.49, "SrII": 2.88, "BaII":2.17, "EuII":0.51})
        sn.add_normalization(handle="loaizatacuri25", author="Loaiza-Tacuri et al.", year=2025, element_dict={"Fe":7.522, "Mg":7.588})
        ...
        #sn.add_normalization(handle="guiglion24", author="Guiglion et al.", year=2025, element_dict={"Fe": 7.50, "BaII":2.18, "Sr":2.87, "YII":2.21})
